<form  method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        value="<?php echo e(old('source') ? old('source') : $artical->picture); ?>"
        >
    </div>

    <div class="form-group">
        <label>Text area</label>
        <textarea class="form-control" name="Artical[articalcontent]" rows="3"><?php echo e(old('Artical')['articalcontent'] ? old('Artical')['articalcontent'] : $artical->articalcontent); ?></textarea>
    </div>
