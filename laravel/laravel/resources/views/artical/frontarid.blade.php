                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="ds-textarea-wrapper ds-rounded-top">
                                                <div class="form-input">
                                                    姓名：
                                                    <input id="name{{ $ment->id }}" name="Ment[comname]" type="text" value="{{\Illuminate\Support\Facades\Cookie::get("cookie")["comname"]}}" maxlength="6">
                                                </div>
                                                <div class="form-input">
                                                    邮箱：
                                                    <input name="Ment[comemail]" id="email{{ $ment->id }}" type="text" value="{{ \Illuminate\Support\Facades\Cookie::get("cookie")["comemail"] }}">
                                                </div>
                                                <textarea name="Ment[comtext]" id="text{{ $ment->id }}" cols="30" rows="10" maxlength="160"></textarea>
