                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="ds-textarea-wrapper ds-rounded-top">
                                                <div class="form-input">
                                                    姓名：
                                                    <input id="name<?php echo e($ment->id); ?>" name="Ment[comname]" type="text" value="<?php echo e(\Illuminate\Support\Facades\Cookie::get("cookie")["comname"]); ?>" maxlength="6">
                                                </div>
                                                <div class="form-input">
                                                    邮箱：
                                                ...
                                                <textarea name="Ment[comtext]" id="text<?php echo e($ment->id); ?>" cols="30" rows="10" maxlength="160"></textarea>
