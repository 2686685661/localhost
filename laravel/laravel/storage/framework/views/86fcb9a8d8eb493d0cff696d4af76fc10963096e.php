                                        ...
                                        <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-2-col-textbox-2 tm-textbox-padding tm-textbox-padding-contact">
                                            ...
                                            <form action="" method="post" class="tm-contact-form">
                                                ...
                                                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 tm-form-group-left">
                                                    <input type="text" id="contact_name" name="message[name]" maxlength="15" size="15" class="form-control" placeholder="Please fill in you name " required="" value="<?php echo e(\Illuminate\Support\Facades\Cookie::get('message')['name']); ?>">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <textarea id="contact_message" name="message[meageContent]" class="form-control" maxlength="160" rows="5" placeholder="Fill Your message" required=""></textarea>
                                                </div>
